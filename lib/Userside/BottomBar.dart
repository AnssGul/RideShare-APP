            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => PrivacyPolicyUserDriver()),
                  );
                },
              ),
              ListTile(
              ...
              ListTile(
                ...
                onTap: () {
                    ...
                    reachUs() async {
                      var androidNumber = "03023275555"; // Update with your Pakistani WhatsApp number

                      var androidUrl = "whatsapp://send?phone=$androidNumber&text=Hi, I need some help";

                      var iOSNumber = "03023275555"; // Update with your Pakistani WhatsApp number

                      var iOSUrl = "https://wa.me/$iOSNumber?text=${Uri.parse("Hi, I need some help")}";
              ...
              ListTile(
                ...
                onTap: () {
                  final String appLink = 'https://PakRiders.com/app'; // Replace with the actual app link
