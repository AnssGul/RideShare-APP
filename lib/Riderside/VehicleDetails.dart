...
class _VehicleDetailsScreenState extends State<VehicleDetailsScreen> {
 ...
 final storeImage =FirebaseStorage.instance.ref().child('images').child('Rider$imgId');
 var task = storeImage.putFile(image!) ;
  final storeImage1 =FirebaseStorage.instance.ref().child('images1').child('Rider$imgId');
  var task1 = storeImage1.putFile(image1!) ;
   final storeImage2 =FirebaseStorage.instance.ref().child('images2').child('Rider$imgId');
...
Future imagePicker()async{
      ...
      Future imagePicker1()async{
         final img1= await picker1.pickImage( source: ImageSource.camera,);
         setState(() {
           image1= File(img1!.path); 
         });
      }
      Future imagePicker2()async{
         final img2= await picker2.pickImage( source: ImageSource.camera,);
         setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    body:  SingleChildScrollView(
      ...
      child: Form(
            ...
            const Text('1. Vehicle Details', style: TextStyle(
             fontSize: 20,
            ...
            const Text('2. CNIC Card', style: TextStyle(
             fontSize: 20,
             fontWeight: FontWeight.bold,
            ),),
                Padding(
            ...
            const Text('3. Vehicle Card', style: TextStyle(
             fontSize: 20,
             fontWeight: FontWeight.bold,
            ),),
                Padding(
            ...
            const Text('4. Selfi Photo', style: TextStyle(
             fontSize: 20,
             fontWeight: FontWeight.bold,
            ),),
                 Padding(
